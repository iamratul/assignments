                    ...
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                ...
                                <p class="mb-0 text-sm">Total Events</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                ...
                                <p class="mb-0 text-sm">Ticket Sales</p>
                            </div>
                        </div>
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
            ...
            <div class="card card-plain h-100 bg-white shadow">
                <div class="p-3">
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                <h3 class="mb-0 text-capitalize font-weight-bold" id="balance">0.00</h3>
