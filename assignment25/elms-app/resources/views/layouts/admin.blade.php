...
<body>
    ...
    <div id="sideNavRef" class="side-nav-open shadow">
        ...
        <a href="{{ url('/admin/add-role') }}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
            <span class="side-bar-item-caption">Add Role</span>
        </a>

        <a href="{{ url('/admin/employee-list') }}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
            <span class="side-bar-item-caption">Employee</span>
        </a>

        <a href="{{ url('/admin/leave-category') }}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
            <span class="side-bar-item-caption">Leave Category</span>
        </a>

        <a href="{{ url('/admin/leave-request') }}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
