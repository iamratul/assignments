                ...
                <div class="row ">
                    ...
                    <div class="col-2">
                        <button data-bs-toggle="modal" data-bs-target="#create-modal"
                            class=" m-0 btn text-bg-primary">Create</button>
                            <button data-bs-toggle="modal" data-bs-target="#email-modal"
                            class="float-end m-0 btn text-bg-success">Send Email</button>
                    </div>
                </div>
                <hr class="bg-dark " />
