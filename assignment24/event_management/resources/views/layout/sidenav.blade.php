...
<body>
                ...
                <div class="user-dropdown">
                    ...
                    <div class="user-dropdown-content ">
                        <div class="mt-4 text-center">
                            <img class="icon-nav-img mb-2" id="userImage" src="" alt="" />
                            <h6 id="userName"></h6>
    ...
    <div id="sideNavRef" class="side-nav-open shadow">
        ...
        <a href="{{ url('/event-category') }}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
            <span class="side-bar-item-caption">Event Category</span>
        </a>

        <a href="{{ url('/events') }}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
